...
function carregarPropostas() {
    ...
    // Apenas renderizamos se houver uma proposta configurada ou a padr�o
    // No caso, sabemos que o slug 'automovelpoker' e 'TesteRiverTech' existem, mas podemos puxar direto do EMPRESA_SLUG.
    // Vamos listar as propostas dispon�veis (mockadas ou lidas de uma tabela de propostas futuramente).
    // Por enquanto, criamos um card fixo com o link din�mico da empresa.
    ...
    const html = \
        <div style="background: rgba(229,178,93,0.05); border: 1px solid rgba(229,178,93,0.3); border-radius: 12px; padding: 20px; transition: all 0.3s;" class="proposta-card">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 15px;">
                <div>
                    <span class="status-badge" style="background: rgba(229,178,93,0.15); color: var(--accent-gold); margin-bottom: 8px; display: inline-block;">Novo M�dulo VIP</span>
                    <h4 style="margin:0; font-size: 1.1rem;">Gest�o de Clientes Premium</h4>
                </div>
            ...
            <p style="font-size: 0.85rem; color: var(--text-secondary); margin-bottom: 20px; line-height: 1.4;">
                Apresenta��o comercial com mockups da funcionalidade de Clientes VIP com limite de gastos e perfis restritos de card�pio.
            </p>
        ...
        <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--border-color); border-radius: 12px; padding: 20px;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 15px;">
                <div>
                    ...
                    <h4 style="margin:0; font-size: 1.1rem;">Sistema Gest�o V1</h4>
                </div>
                <div style="background: rgba(0,0,0,0.3); padding: 8px; border-radius: 8px;">??</div>
            </div>
            <p style="font-size: 0.85rem; color: var(--text-secondary); margin-bottom: 20px; line-height: 1.4;">
                Apresenta��o completa do sistema de gest�o com card�pio digital, QR Code e painel administrativo master.
            </p>
