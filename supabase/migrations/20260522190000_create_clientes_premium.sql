...
DROP POLICY IF EXISTS "anon_all_perfis_cardapio" ON perfis_cardapio;
...
DROP POLICY IF EXISTS "anon_all_perfil_cardapio_categorias" ON perfil_cardapio_categorias;
...
DROP POLICY IF EXISTS "anon_all_clientes_premium" ON clientes_premium;
CREATE POLICY "anon_all_clientes_premium" ON clientes_premium FOR ALL USING (true) WITH CHECK (true);

-- comandas
ALTER TABLE comandas ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "anon_all_comandas" ON comandas;
