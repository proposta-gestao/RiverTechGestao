-- Migration: Adicionar configurações de WhatsApp na store_settings
-- Permite que cada empresa configure número, mensagem e quais tipos de retirada
...
COMMENT ON COLUMN public.store_settings.whatsapp_numero IS 'Número do WhatsApp com DDI. Ex: 5531999999999';
